...
{
  /// <summary>Configurator for <see cref="BlueprintEtudeConflictingGroup"/>.</summary>
  /// <inheritdoc/>
  ...
  public class EtudeConflictingGroupConfigurator : BaseBlueprintConfigurator<BlueprintEtudeConflictingGroup, EtudeConflictingGroupConfigurator>
  {
    ...
    public static EtudeConflictingGroupConfigurator New(string name, string assetId)
    {

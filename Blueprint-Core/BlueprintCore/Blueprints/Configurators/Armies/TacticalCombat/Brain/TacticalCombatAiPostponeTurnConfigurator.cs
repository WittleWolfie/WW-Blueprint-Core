...
{
  /// <summary>Configurator for <see cref="BlueprintTacticalCombatAiPostponeTurn"/>.</summary>
  /// <inheritdoc/>
  ...
  public class TacticalCombatAiPostponeTurnConfigurator : BaseTacticalCombatAiActionConfigurator<BlueprintTacticalCombatAiPostponeTurn, TacticalCombatAiPostponeTurnConfigurator>
  {
    ...
    public static TacticalCombatAiPostponeTurnConfigurator New(string name, string assetId)
    {

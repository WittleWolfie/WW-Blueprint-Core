...
namespace BlueprintCore.Blueprints.Configurators.Facts
{
      ...
      where TBuilder : BaseBlueprintConfigurator<T, TBuilder>
  {
    ...
    public TBuilder AddAddClassLevels(
    ...
    public TBuilder AddAddACBonusWithDistanceToMasterCondition(
        ContextValue Value,
    ...
    public TBuilder AddAddAbilityResourceTrigger(
        string m_Resource,
        ActionsBuilder Action)
    {
    ...
    public TBuilder AddAddAbilityUseTargetTrigger(
        ActionsBuilder Action,
        bool AfterCast,
        bool FromSpellbook,
        AbilityType Type,
    ...
    public TBuilder AddAddAbilityUseTrigger(
        ActionsBuilder Action,
    ...
    public TBuilder AddAddAdditionalLimb(
        string m_Weapon)
    {
    ...
    public TBuilder AddAddBackgroundArmorProficiency(
    ...
    public TBuilder AddAddBackgroundClassSkill(
        StatType Skill)
    {
      ValidateParam(Skill);
    ...
    public TBuilder AddAddBackgroundWeaponProficiency(
    ...
    public TBuilder AddAddBondProperty(
    ...
    public TBuilder AddAddClassSkill(
        StatType Skill)
    {
      ValidateParam(Skill);
    ...
    public TBuilder AddAddClusteredAttack(
    ...
    public TBuilder AddAddConcealment(
    ...
    public TBuilder AddAddCondition(
    ...
    public TBuilder AddAddConditionImmunity(
        UnitCondition Condition)
    {
      ValidateParam(Condition);
    ...
    public TBuilder AddAddConditionTrigger(
    ...
    public TBuilder AddAddDamageResistanceEnergy(
    ...
    public TBuilder AddAddDamageResistanceForce(
        DamageEnergyType Type,
        bool UseValueMultiplier,
        ContextValue ValueMultiplier,
        ContextValue Value,
    ...
    public TBuilder AddAddDamageResistancePhysical(
        bool Or,
    ...
    public TBuilder AddAddDamageTypeVulnerability(
        bool PhyscicalForm,
    ...
    public TBuilder AddAddEnergyDamageDivisor()
    {
    ...
    public TBuilder AddAddEnergyDamageImmunity(
    ...
    public TBuilder AddAddEnergyImmunity(
        DamageEnergyType Type)
    {
      ValidateParam(Type);
    ...
    public TBuilder AddAddEnergyVulnerability(
        DamageEnergyType Type)
    {
      ValidateParam(Type);
    ...
    public TBuilder AddAddEquipmentEntity(
    ...
    public TBuilder AddAddFactsFromCaster(
        string[] m_Facts,
    ...
    public TBuilder AddAddFactsToMount(
        string[] m_Facts,
        int CasterLevel)
    {
    ...
    public TBuilder AddAddFallProneTrigger(
        ActionsBuilder Action)
    {
    ...
    public TBuilder AddAddFamiliar(
    ...
    public TBuilder AddAddForceMove(
    ...
    public TBuilder AddAddFortification(
    ...
    public TBuilder AddAddHealTrigger(
        ActionsBuilder Action,
    ...
    public TBuilder AddAddIdentifyBonus(
    ...
    public TBuilder AddAddImmortality()
    {
    ...
    public TBuilder AddAddImmunityFirebrand()
    {
    ...
    public TBuilder AddAddImmunityToAbilityScoreDamage(
        bool Drain,
        StatType[] StatTypes)
    {
    ...
    public TBuilder AddAddImmunityToCriticalHits()
    {
    ...
    public TBuilder AddAddImmunityToEnergyDrain()
    {
    ...
    public TBuilder AddAddImmunityToPrecisionDamage()
    {
    ...
    public TBuilder AddAddIncomingDamageWeaponProperty(
        bool AddMagic,
        bool AddMaterial,
        PhysicalDamageMaterial Material,
        bool AddForm,
    ...
    public TBuilder AddAddIncorporealDamageDivisor()
    {
    ...
    public TBuilder AddAddInitiatorHealTrigger(
        ActionsBuilder Action,
        ActionsBuilder HealerAction,
        bool OnHealDamage,
        bool OnHealStatDamage,
    ...
    public TBuilder AddAddItemCasterLevelBonus(
        int Bonus,
    ...
    public TBuilder AddAddKnownSpell(
        string m_CharacterClass,
        int SpellLevel,
        string m_Spell,
        string m_Archetype)
    ...
    public TBuilder AddAddLootToVendorTable(
        string m_Loot)
    {
    ...
    public TBuilder AddAddMechanicsFeature(
    ...
    public TBuilder AddAddMetamagicFeat(
        Metamagic Metamagic)
    {
    ...
    public TBuilder AddAddMythicEnemyHitPointsBonus()
    {
    ...
    public TBuilder AddAddNimbusDamageDivisor(
    ...
    public TBuilder AddAddOffensiveActionTrigger(
        ActionsBuilder Action)
    {
    ...
    public TBuilder AddAddOppositionDescriptor(
        string m_CharacterClass,
    ...
    public TBuilder AddAddOppositionSchool(
        string m_CharacterClass,
        SpellSchool School)
    {
    ...
    public TBuilder AddAddOutgoingDamageBonus(
    ...
    public TBuilder AddAddOutgoingPhysicalDamageProperty(
    ...
    public TBuilder AddAddOverHealTrigger(
    ...
    public TBuilder AddAddParametrizedClassSkill()
    {
    ...
    public TBuilder AddAddParametrizedFeatures(
    ...
    public TBuilder AddAddParametrizedStatBonus(
        ContextValue Value,
        ModifierDescriptor Descriptor)
    {
      ValidateParam(Value);
    ...
    public TBuilder AddAddPhysicalImmunity()
    {
    ...
    public TBuilder AddAddProficiencies(
    ...
    public TBuilder AddAddREVendorItem()
    {
    ...
    public TBuilder AddAddResurrectOnRest()
    {
    ...
    public TBuilder AddAddRunwayLogic()
    {
    ...
    public TBuilder AddAddSecondaryAttacks(
        string[] m_Weapon)
    {
    ...
    public TBuilder AddAddSharedVendor(
        string m_m_Table)
    {
    ...
    public TBuilder AddAddSkillPointPerCharacterLevel()
    {
    ...
    public TBuilder AddAddSpecialSpellList(
        string m_CharacterClass,
        string m_SpellList,
    ...
    public TBuilder AddAddSpecialSpellListForArchetype(
        string m_CharacterClass,
        string m_SpellList,
        string m_Archetype)
    {
    ...
    public TBuilder AddAddSpellFailureChance(
        int Chance,
        GameObject FailFx)
    {
      ValidateParam(FailFx);
    ...
    public TBuilder AddAddSpellImmunity(
    ...
    public TBuilder AddAddSpellKnownTemporary(
        string m_CharacterClass,
        string m_Spell,
        int Level,
    ...
    public TBuilder AddAddSpellLevelLimit(
        int ForMaxLevel9,
        int ForMaxLevel6,
        int ForMaxLevel4)
    {
    ...
    public TBuilder AddAddSpellResistance(
        bool AddCR,
        ContextValue Value,
    ...
    public TBuilder AddAddSpellTypeFailureChance(
        int Chance,
        GameObject FailFx,
        bool Arcane,
        bool Divine,
    ...
    public TBuilder AddAddStartingEquipment(
        string[] m_BasicItems,
    ...
    public TBuilder AddAddStatBonus(
        ModifierDescriptor Descriptor,
        StatType Stat,
        int Value,
    ...
    public TBuilder AddAddStatModifier(
        ModifierDescriptor Descriptor,
        StatType Stat,
    ...
    public TBuilder AddAddTemporaryFeat(
        string m_Feat)
    {
    ...
    public TBuilder AddAddUnlimitedSpell(
        string[] m_Abilities)
    {
    ...
    public TBuilder AddAddVendorItems(
        string m_Loot)
    {
    ...
    public TBuilder AddAdditionalDamageOnSneakAttack(
        int Value,
        bool OnlyRanged)
    {
    ...
    public TBuilder AddLimbsApartDismembermentRestricted()
    {
    ...
    public TBuilder AddAddKineticistAcceptBurnTrigger(
        ActionsBuilder Action)
    {
    ...
    public TBuilder AddAddKineticistBlade(
        string m_Blade)
    {
    ...
    public TBuilder AddAddKineticistBurnModifier(
    ...
    public TBuilder AddAddKineticistBurnValueChangedTrigger(
        ActionsBuilder Action)
    {
    ...
    public TBuilder AddAddKineticistElementalOverflow(
        ContextValue Bonus,
        bool IgnoreBurn,
    ...
    public TBuilder AddAddKineticistPart(
        string m_Class,
        StatType MainStat,
        string m_MaxBurn,
    ...
    public TBuilder AddAddAreaEffect(
        string m_AreaEffect)
    {
    ...
    public TBuilder AddAddEffectContextFastHealing(
        ContextValue Bonus)
    {
      ValidateParam(Bonus);
    ...
    /// <summary>
    /// Adds <see cref="AddEffectFastHealing"/> (Auto Generated)
    /// </summary>
    [Generated]
    [Implements(typeof(AddEffectFastHealing))]
    public TBuilder AddAddEffectFastHealing(
        int Heal,
        ContextValue Bonus)
    {
      ValidateParam(Bonus);
    ...
    public TBuilder AddAddEffectRegeneration(
        int Heal,
        bool Unremovable,
    ...
    public TBuilder AddAddGenericStatBonus(
        ModifierDescriptor Descriptor,
        StatType Stat,
        int Value)
    {
    ...
    public TBuilder AddAddMirrorImage(
    ...
    public TBuilder AddAddEnergyDamageTrigger(
    ...
    public TBuilder AddAddIncomingDamageTrigger(
        ActionsBuilder Actions,
    ...
    public TBuilder AddAddInitiatorPartySkillRollTrigger(
        bool OnlySuccess,
        StatType Skill,
        ActionsBuilder Action)
    {
    ...
    public TBuilder AddAddInitiatorSavingThrowTrigger(
        bool OnlyPass,
        bool OnlyFail,
        ActionsBuilder Action)
    {
    ...
    public TBuilder AddAddInitiatorSkillRollTrigger(
        bool OnlySuccess,
        StatType Skill,
        ActionsBuilder Action)
    {
    ...
    public TBuilder AddAddKineticistInfusionDamageTrigger(
        ActionsBuilder Actions,
        bool TriggerOnStatDamageOrEnergyDrain,
        bool CheckWeaponType,
    ...
    public TBuilder AddAddOutgoingDamageTrigger(
        ActionsBuilder Actions,
        bool TriggerOnStatDamageOrEnergyDrain,
        bool CheckWeaponType,
        bool CheckAbilityType,
    ...
    public TBuilder AddAddSpellDiceBonusTrigger(
        bool CheckSpellDescriptor,
        SpellDescriptorWrapper SpellDescriptorsList,
    ...
    public TBuilder AddAddTargetAttackWithWeaponTrigger(
    ...
    public TBuilder AddAddTargetSavingThrowTrigger(
        bool OnlyPass,
        bool OnlyFail,
        ActionsBuilder Action)
    {
    ...
    public TBuilder AddAddTargetSpellResistanceCheckTrigger(
        bool OnlyPass,
        bool OnlyFail,
        ActionsBuilder Action)
    {
    ...
    public TBuilder AddAttackBonusAgainstTacticalOwner(
    ...
    public TBuilder AddAttackBonusAgainstTacticalTarget(
        TargetFilter m_TargetFilter,
        ContextValue m_Value,
        ModifierDescriptor Descriptor)
    {
    ...
    public TBuilder AddDamageBonusAgainstTacticalOwner(
        TargetFilter m_TargetFilter,
    ...
    public TBuilder AddAddAbilityResources(
    ...
    public TBuilder AddAddBuffOnCombatStart(
        bool CheckParty,
        string m_Feature)
    {
    ...
    public TBuilder AddAddCalculatedWeapon(
    ...
    public TBuilder AddAddCasterLevel(
        int Bonus,
        ModifierDescriptor Descriptor)
    {
      ValidateParam(Descriptor);
    ...
    public TBuilder AddAddCasterLevelForAbility(
        string m_Spell,
        int Bonus,
        ModifierDescriptor Descriptor)
    {
    ...
    public TBuilder AddAddCasterLevelForSpellbook(
        int Bonus,
        ModifierDescriptor Descriptor,
        string[] m_Spellbooks)
    {
    ...
    public TBuilder AddAddClassLevelToSummonDuration(
        string m_CharacterClass,
        bool Half)
    {
    ...
    public TBuilder AddAddFactIfArchetype(
        string m_Feature,
        string m_CharacterClass,
        string m_Archetype)
    {
    ...
    public TBuilder AddAddFeatureIfHasFact(
        string m_CheckedFact,
        string m_Feature,
        bool Not)
    {
    ...
    public TBuilder AddAddFeatureOnAlignment(
        AlignmentComponent Alignment,
        string[] m_Facts)
    {
      ValidateParam(Alignment);
    ...
    public TBuilder AddAddFeatureOnApply(
        string m_Feature)
    {
    ...
    public TBuilder AddAddFeatureOnClassLevel(
        string m_Class,
        int Level,
        string m_Feature,
    ...
    public TBuilder AddAddFeatureOnSkill(
        StatType StatType,
        int MinimalStat,
        string[] m_Facts)
    {
    ...
    public TBuilder AddAddFeatureParametrized()
    {
    ...
    public TBuilder AddAddFeatureToNPC(
        bool CheckParty,
        string m_Feature,
        bool CheckSummoned)
    {
    ...
    public TBuilder AddAddFeatureToPet(
        PetType m_PetType,
        string m_Feature)
    {
      ValidateParam(m_PetType);
    ...
    public TBuilder AddAddFeatureToPetParametrized(
        PetType PetType)
    {
    ...
    public TBuilder AddAddSpellListAsAbilities(
    ...
    public TBuilder AddAddSpellbook(
        string m_Spellbook,
    ...
    public TBuilder AddAdditionalDamageOnHit(
    ...
    public TBuilder AddAdditionalSneakDamageOnHit(
    ...
    public TBuilder AddAddAdditionalLimbIfHasFact(
        string m_Weapon,
        string m_CheckedFact)
    {
    ...
    public TBuilder AddAddStatBonusAbilityValue(
        ModifierDescriptor Descriptor,
        StatType Stat,
        ContextValue Value)
    {
    ...
    public TBuilder AddAddStatBonusIfHasFact(
        ModifierDescriptor Descriptor,
        StatType Stat,
        ContextValue Value,
    ...
    public TBuilder AddAddStatBonusIfHasSkill(
        ModifierDescriptor Descriptor,
        StatType Stat,
        int ValueTrue,
        int ValueFalse,
    ...
    public TBuilder AddAddStatBonusScaled(
        ModifierDescriptor Descriptor,
        StatType Stat,
        int Value,
        BuffScaling Scaling)
    ...
    public TBuilder AddApplyBuffOnHit(
        string m_buff,
        Rounds time)
    {
      ValidateParam(time);
    ...
    /// <summary>
    /// Adds <see cref="BuffSleeping"/> (Auto Generated)
    /// </summary>
    [Generated]
    ...
    public TBuilder AddGreaterSnapShotBonus(
        ContextValue Value,
        ModifierDescriptor Descriptor)
    {
      ValidateParam(Value);

...
{
  /// <summary>Configurator for <see cref="CanUseSpellCombatConsideration"/>.</summary>
  /// <inheritdoc/>
  ...
  public class CanUseSpellCombatConsiderationConfigurator : BaseConsiderationConfigurator<CanUseSpellCombatConsideration, CanUseSpellCombatConsiderationConfigurator>
  {
    ...
    public static CanUseSpellCombatConsiderationConfigurator New(string name, string assetId)
    {

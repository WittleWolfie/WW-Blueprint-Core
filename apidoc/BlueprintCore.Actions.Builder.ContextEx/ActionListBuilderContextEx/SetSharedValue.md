# ActionListBuilderContextEx.SetSharedValue method

Adds ContextActionChangeSharedValue

```csharp
public static ActionListBuilder SetSharedValue(this ActionListBuilder builder, 
    AbilitySharedValue sharedValue, ContextValue setValue)
```

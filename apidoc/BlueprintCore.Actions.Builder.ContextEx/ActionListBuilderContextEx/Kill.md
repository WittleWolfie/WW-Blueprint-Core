# ActionListBuilderContextEx.Kill method

Adds ContextActionKill

```csharp
public static ActionListBuilder Kill(this ActionListBuilder builder, 
    DismemberType dismember = DismemberType.None)
```

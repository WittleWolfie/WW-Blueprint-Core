# BlueprintConfigurator&lt;T,TBuilder&gt;.PrerequisitePlayerHasFeature method

Adds PrerequisitePlayerHasFeature

```csharp
public TBuilder PrerequisitePlayerHasFeature(string feature, GroupType group = GroupType.All, 

...
namespace BlueprintCore.Blueprints.Configurators.Quests
{
  ...
  {
    private QuestObjectiveConfigurator(Blueprint<BlueprintQuestObjective, BlueprintReference<BlueprintQuestObjective>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static QuestObjectiveConfigurator For(Blueprint<BlueprintQuestObjective, BlueprintReference<BlueprintQuestObjective>> blueprint)
    {

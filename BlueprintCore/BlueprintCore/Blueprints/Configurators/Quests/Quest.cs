...
namespace BlueprintCore.Blueprints.Configurators.Quests
{
  ...
  {
    private QuestConfigurator(Blueprint<BlueprintQuest, BlueprintReference<BlueprintQuest>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static QuestConfigurator For(Blueprint<BlueprintQuest, BlueprintReference<BlueprintQuest>> blueprint)
    {

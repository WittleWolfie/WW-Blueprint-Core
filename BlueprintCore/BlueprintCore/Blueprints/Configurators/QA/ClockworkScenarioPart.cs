...
namespace BlueprintCore.Blueprints.Configurators.QA
{
  ...
  {
    private ClockworkScenarioPartConfigurator(Blueprint<BlueprintClockworkScenarioPart, BlueprintReference<BlueprintClockworkScenarioPart>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ClockworkScenarioPartConfigurator For(Blueprint<BlueprintClockworkScenarioPart, BlueprintReference<BlueprintClockworkScenarioPart>> blueprint)
    {

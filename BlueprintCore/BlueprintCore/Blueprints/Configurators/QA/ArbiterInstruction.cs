...
namespace BlueprintCore.Blueprints.Configurators.QA
{
  ...
  {
    private ArbiterInstructionConfigurator(Blueprint<BlueprintArbiterInstruction, BlueprintReference<BlueprintArbiterInstruction>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ArbiterInstructionConfigurator For(Blueprint<BlueprintArbiterInstruction, BlueprintReference<BlueprintArbiterInstruction>> blueprint)
    {

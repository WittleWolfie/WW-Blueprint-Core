...
namespace BlueprintCore.Blueprints.Configurators.QA
{
  ...
  {
    private ClockworkScenarioConfigurator(Blueprint<BlueprintReference<BlueprintClockworkScenario>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ClockworkScenarioConfigurator For(Blueprint<BlueprintReference<BlueprintClockworkScenario>> blueprint)
    {

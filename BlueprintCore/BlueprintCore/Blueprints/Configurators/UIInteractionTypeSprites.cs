...
namespace BlueprintCore.Blueprints.Configurators
{
  ...
  {
    private UIInteractionTypeSpritesConfigurator(Blueprint<BlueprintUIInteractionTypeSprites, BlueprintReference<BlueprintUIInteractionTypeSprites>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static UIInteractionTypeSpritesConfigurator For(Blueprint<BlueprintUIInteractionTypeSprites, BlueprintReference<BlueprintUIInteractionTypeSprites>> blueprint)
    {

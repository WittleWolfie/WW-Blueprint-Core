...
namespace BlueprintCore.Blueprints.Configurators.Tutorial
{
  ...
  {
    private TutorialConfigurator(Blueprint<BlueprintTutorial, BlueprintReference<BlueprintTutorial>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static TutorialConfigurator For(Blueprint<BlueprintTutorial, BlueprintReference<BlueprintTutorial>> blueprint)
    {

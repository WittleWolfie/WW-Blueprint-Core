...
namespace BlueprintCore.Blueprints.Configurators.Credits
{
  ...
  {
    private CreditsGroupConfigurator(Blueprint<BlueprintReference<BlueprintCreditsGroup>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static CreditsGroupConfigurator For(Blueprint<BlueprintReference<BlueprintCreditsGroup>> blueprint)
    {

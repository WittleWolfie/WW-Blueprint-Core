...
namespace BlueprintCore.Blueprints.Configurators.Credits
{
  ...
  {
    private CreditsTeamsConfigurator(Blueprint<BlueprintReference<BlueprintCreditsTeams>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static CreditsTeamsConfigurator For(Blueprint<BlueprintReference<BlueprintCreditsTeams>> blueprint)
    {

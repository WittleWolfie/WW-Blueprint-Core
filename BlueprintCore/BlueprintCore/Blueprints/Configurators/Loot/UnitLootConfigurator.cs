...
namespace BlueprintCore.Blueprints.Configurators.Loot
{
  ...
  {
    private UnitLootConfigurator(Blueprint<BlueprintReference<BlueprintUnitLoot>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static UnitLootConfigurator For(Blueprint<BlueprintReference<BlueprintUnitLoot>> blueprint)
    {
    ...
    public UnitLootConfigurator CopyFrom(

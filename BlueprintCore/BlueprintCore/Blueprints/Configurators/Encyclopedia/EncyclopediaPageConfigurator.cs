...
namespace BlueprintCore.Blueprints.Configurators.Encyclopedia
{
  ...
  {
    private EncyclopediaPageConfigurator(Blueprint<BlueprintReference<BlueprintEncyclopediaPage>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static EncyclopediaPageConfigurator For(Blueprint<BlueprintReference<BlueprintEncyclopediaPage>> blueprint)
    {

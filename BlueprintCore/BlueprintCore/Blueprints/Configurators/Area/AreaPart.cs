...
namespace BlueprintCore.Blueprints.Configurators.Area
{
  ...
  {
    private AreaPartConfigurator(Blueprint<BlueprintAreaPart, BlueprintReference<BlueprintAreaPart>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static AreaPartConfigurator For(Blueprint<BlueprintAreaPart, BlueprintReference<BlueprintAreaPart>> blueprint)
    {

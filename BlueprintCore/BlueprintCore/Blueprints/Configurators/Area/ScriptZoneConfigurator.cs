...
namespace BlueprintCore.Blueprints.Configurators.Area
{
  ...
  {
    private ScriptZoneConfigurator(Blueprint<BlueprintReference<BlueprintScriptZone>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ScriptZoneConfigurator For(Blueprint<BlueprintReference<BlueprintScriptZone>> blueprint)
    {

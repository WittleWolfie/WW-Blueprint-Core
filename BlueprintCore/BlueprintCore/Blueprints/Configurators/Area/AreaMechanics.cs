...
namespace BlueprintCore.Blueprints.Configurators.Area
{
  ...
  {
    private AreaMechanicsConfigurator(Blueprint<BlueprintAreaMechanics, BlueprintReference<BlueprintAreaMechanics>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static AreaMechanicsConfigurator For(Blueprint<BlueprintAreaMechanics, BlueprintReference<BlueprintAreaMechanics>> blueprint)
    {

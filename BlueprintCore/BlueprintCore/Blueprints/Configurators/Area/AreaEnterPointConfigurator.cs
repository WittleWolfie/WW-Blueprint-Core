...
namespace BlueprintCore.Blueprints.Configurators.Area
{
  ...
  {
    private AreaEnterPointConfigurator(Blueprint<BlueprintReference<BlueprintAreaEnterPoint>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static AreaEnterPointConfigurator For(Blueprint<BlueprintReference<BlueprintAreaEnterPoint>> blueprint)
    {
    ...
    public AreaEnterPointConfigurator CopyFrom(

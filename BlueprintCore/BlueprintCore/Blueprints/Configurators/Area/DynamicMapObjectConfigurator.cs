...
namespace BlueprintCore.Blueprints.Configurators.Area
{
  ...
  {
    private DynamicMapObjectConfigurator(Blueprint<BlueprintReference<BlueprintDynamicMapObject>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static DynamicMapObjectConfigurator For(Blueprint<BlueprintReference<BlueprintDynamicMapObject>> blueprint)
    {
    ...
    public DynamicMapObjectConfigurator CopyFrom(
    ...
    public DynamicMapObjectConfigurator CopyFrom(
      Blueprint<BlueprintReference<BlueprintDynamicMapObject>> blueprint, Predicate<BlueprintComponent> componentMatcher)
    {

...
namespace BlueprintCore.Blueprints.Configurators.DialogSystem
{
  ...
  {
    private MythicInfoConfigurator(Blueprint<BlueprintReference<BlueprintMythicInfo>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static MythicInfoConfigurator For(Blueprint<BlueprintReference<BlueprintMythicInfo>> blueprint)
    {
    ...
    public MythicInfoConfigurator CopyFrom(

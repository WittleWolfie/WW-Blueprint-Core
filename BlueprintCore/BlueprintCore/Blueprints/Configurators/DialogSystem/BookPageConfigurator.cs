...
namespace BlueprintCore.Blueprints.Configurators.DialogSystem
{
  ...
  {
    private BookPageConfigurator(Blueprint<BlueprintReference<BlueprintBookPage>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static BookPageConfigurator For(Blueprint<BlueprintReference<BlueprintBookPage>> blueprint)
    {
    ...
    public BookPageConfigurator CopyFrom(

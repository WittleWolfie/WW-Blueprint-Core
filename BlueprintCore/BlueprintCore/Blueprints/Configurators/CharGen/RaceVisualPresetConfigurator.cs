...
namespace BlueprintCore.Blueprints.Configurators.CharGen
{
  ...
  {
    private RaceVisualPresetConfigurator(Blueprint<BlueprintReference<BlueprintRaceVisualPreset>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static RaceVisualPresetConfigurator For(Blueprint<BlueprintReference<BlueprintRaceVisualPreset>> blueprint)
    {

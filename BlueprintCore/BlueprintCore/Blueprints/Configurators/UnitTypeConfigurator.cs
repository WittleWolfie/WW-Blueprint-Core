...
namespace BlueprintCore.Blueprints.Configurators
{
  ...
  {
    private UnitTypeConfigurator(Blueprint<BlueprintReference<BlueprintUnitType>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static UnitTypeConfigurator For(Blueprint<BlueprintReference<BlueprintUnitType>> blueprint)
    {
    ...
    public UnitTypeConfigurator CopyFrom(

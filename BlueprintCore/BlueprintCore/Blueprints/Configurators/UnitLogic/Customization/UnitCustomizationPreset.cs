...
namespace BlueprintCore.Blueprints.Configurators.UnitLogic.Customization
{
  ...
  {
    private UnitCustomizationPresetConfigurator(Blueprint<UnitCustomizationPreset, BlueprintReference<UnitCustomizationPreset>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static UnitCustomizationPresetConfigurator For(Blueprint<UnitCustomizationPreset, BlueprintReference<UnitCustomizationPreset>> blueprint)
    {

...
namespace BlueprintCore.Blueprints.Configurators.UnitLogic.Abilities
{
  ...
  {
    private AreaEffectPitVisualSettingsConfigurator(Blueprint<BlueprintReference<BlueprintAreaEffectPitVisualSettings>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static AreaEffectPitVisualSettingsConfigurator For(Blueprint<BlueprintReference<BlueprintAreaEffectPitVisualSettings>> blueprint)
    {

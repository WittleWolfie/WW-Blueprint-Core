...
namespace BlueprintCore.Blueprints.Configurators.Armies.Brain
{
  ...
  {
    private TacticalCombatTagConsiderationConfigurator(Blueprint<TacticalCombatTagConsideration, BlueprintReference<TacticalCombatTagConsideration>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static TacticalCombatTagConsiderationConfigurator For(Blueprint<TacticalCombatTagConsideration, BlueprintReference<TacticalCombatTagConsideration>> blueprint)
    {

...
namespace BlueprintCore.Blueprints.Configurators.Armies.Brain
{
  ...
  {
    private TacticalCombatAiAttackConfigurator(Blueprint<BlueprintTacticalCombatAiAttack, BlueprintReference<BlueprintTacticalCombatAiAttack>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static TacticalCombatAiAttackConfigurator For(Blueprint<BlueprintTacticalCombatAiAttack, BlueprintReference<BlueprintTacticalCombatAiAttack>> blueprint)
    {

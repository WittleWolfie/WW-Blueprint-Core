...
namespace BlueprintCore.Blueprints.Configurators.Armies
{
  ...
  {
    private TacticalCombatAreaConfigurator(Blueprint<BlueprintReference<BlueprintTacticalCombatArea>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static TacticalCombatAreaConfigurator For(Blueprint<BlueprintReference<BlueprintTacticalCombatArea>> blueprint)
    {
    ...
    public TacticalCombatAreaConfigurator CopyFrom(

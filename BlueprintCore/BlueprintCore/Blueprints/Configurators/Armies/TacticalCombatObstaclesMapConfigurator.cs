...
namespace BlueprintCore.Blueprints.Configurators.Armies
{
  ...
  {
    private TacticalCombatObstaclesMapConfigurator(Blueprint<BlueprintReference<BlueprintTacticalCombatObstaclesMap>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static TacticalCombatObstaclesMapConfigurator For(Blueprint<BlueprintReference<BlueprintTacticalCombatObstaclesMap>> blueprint)
    {

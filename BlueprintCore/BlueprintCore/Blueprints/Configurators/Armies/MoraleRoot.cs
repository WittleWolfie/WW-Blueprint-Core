...
namespace BlueprintCore.Blueprints.Configurators.Armies
{
  ...
  {
    private MoraleRootConfigurator(Blueprint<MoraleRoot, BlueprintReference<MoraleRoot>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static MoraleRootConfigurator For(Blueprint<MoraleRoot, BlueprintReference<MoraleRoot>> blueprint)
    {

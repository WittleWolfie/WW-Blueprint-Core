...
namespace BlueprintCore.Blueprints.Configurators.Kingdom
{
  ...
  {
    private CrusadeEventConfigurator(Blueprint<BlueprintReference<BlueprintCrusadeEvent>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static CrusadeEventConfigurator For(Blueprint<BlueprintReference<BlueprintCrusadeEvent>> blueprint)
    {
    ...
    public CrusadeEventConfigurator CopyFrom(
    ...
    public CrusadeEventConfigurator CopyFrom(
      Blueprint<BlueprintReference<BlueprintCrusadeEvent>> blueprint, Predicate<BlueprintComponent> componentMatcher)
    {

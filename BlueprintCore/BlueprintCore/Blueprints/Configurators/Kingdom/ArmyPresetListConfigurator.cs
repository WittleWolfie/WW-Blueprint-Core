...
namespace BlueprintCore.Blueprints.Configurators.Kingdom
{
  ...
  {
    private ArmyPresetListConfigurator(Blueprint<BlueprintReference<BlueprintArmyPresetList>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ArmyPresetListConfigurator For(Blueprint<BlueprintReference<BlueprintArmyPresetList>> blueprint)
    {
    ...
    public ArmyPresetListConfigurator CopyFrom(

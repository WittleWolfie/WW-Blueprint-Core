...
namespace BlueprintCore.Blueprints.Configurators.Kingdom
{
  ...
  {
    private KingdomBuffConfigurator(Blueprint<BlueprintKingdomBuff, BlueprintReference<BlueprintKingdomBuff>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static KingdomBuffConfigurator For(Blueprint<BlueprintKingdomBuff, BlueprintReference<BlueprintKingdomBuff>> blueprint)
    {

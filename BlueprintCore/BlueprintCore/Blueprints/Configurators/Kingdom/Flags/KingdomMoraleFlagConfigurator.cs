...
using BlueprintCore.Blueprints.Configurators.Kingdom.Flags;
...
namespace BlueprintCore.Blueprints.Configurators.Kingdom.Flags
{
  ...
  {
    private KingdomMoraleFlagConfigurator(Blueprint<BlueprintReference<BlueprintKingdomMoraleFlag>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static KingdomMoraleFlagConfigurator For(Blueprint<BlueprintReference<BlueprintKingdomMoraleFlag>> blueprint)
    {
    ...
    public KingdomMoraleFlagConfigurator CopyFrom(
      Blueprint<BlueprintReference<BlueprintKingdomMoraleFlag>> blueprint, Predicate<BlueprintComponent> componentMatcher)
    {

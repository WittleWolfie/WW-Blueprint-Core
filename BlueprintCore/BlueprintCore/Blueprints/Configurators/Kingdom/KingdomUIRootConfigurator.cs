...
namespace BlueprintCore.Blueprints.Configurators.Kingdom
{
  ...
  {
    private KingdomUIRootConfigurator(Blueprint<BlueprintReference<KingdomUIRoot>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static KingdomUIRootConfigurator For(Blueprint<BlueprintReference<KingdomUIRoot>> blueprint)
    {
    ...
    public KingdomUIRootConfigurator CopyFrom(

...
namespace BlueprintCore.Blueprints.Configurators.Kingdom
{
  ...
  {
    private LeadersRootConfigurator(Blueprint<LeadersRoot, BlueprintReference<LeadersRoot>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static LeadersRootConfigurator For(Blueprint<LeadersRoot, BlueprintReference<LeadersRoot>> blueprint)
    {

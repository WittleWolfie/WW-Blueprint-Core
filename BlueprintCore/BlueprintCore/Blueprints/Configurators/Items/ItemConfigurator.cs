...
namespace BlueprintCore.Blueprints.Configurators.Items
{
  ...
  public class ItemConfigurator
    : BaseItemConfigurator<BlueprintItem, ItemConfigurator>
  {
    private ItemConfigurator(Blueprint<BlueprintReference<BlueprintItem>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ItemConfigurator For(Blueprint<BlueprintReference<BlueprintItem>> blueprint)
    {
      return new ItemConfigurator(blueprint);
    }
    /// <summary>
    ...
    public ItemConfigurator CopyFrom(

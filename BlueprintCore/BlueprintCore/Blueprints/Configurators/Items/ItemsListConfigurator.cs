...
namespace BlueprintCore.Blueprints.Configurators.Items
{
  ...
  {
    private ItemsListConfigurator(Blueprint<BlueprintReference<BlueprintItemsList>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ItemsListConfigurator For(Blueprint<BlueprintReference<BlueprintItemsList>> blueprint)
    {
    ...
    public ItemsListConfigurator CopyFrom(
    ...
    public ItemsListConfigurator CopyFrom(
      Blueprint<BlueprintReference<BlueprintItemsList>> blueprint, Predicate<BlueprintComponent> componentMatcher)
    {

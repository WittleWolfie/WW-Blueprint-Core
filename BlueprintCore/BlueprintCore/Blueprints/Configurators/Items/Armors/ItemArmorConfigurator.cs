...
namespace BlueprintCore.Blueprints.Configurators.Items.Armors
{
  ...
  {
    private ItemArmorConfigurator(Blueprint<BlueprintReference<BlueprintItemArmor>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ItemArmorConfigurator For(Blueprint<BlueprintReference<BlueprintItemArmor>> blueprint)
    {
    ...
    public ItemArmorConfigurator CopyFrom(
    ...
    public ItemArmorConfigurator CopyFrom(
      Blueprint<BlueprintReference<BlueprintItemArmor>> blueprint, Predicate<BlueprintComponent> componentMatcher)
    {

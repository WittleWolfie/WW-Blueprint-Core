...
namespace BlueprintCore.Blueprints.Configurators.Items.Shields
{
  ...
  {
    private ItemShieldConfigurator(Blueprint<BlueprintItemShield, BlueprintReference<BlueprintItemShield>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ItemShieldConfigurator For(Blueprint<BlueprintItemShield, BlueprintReference<BlueprintItemShield>> blueprint)
    {

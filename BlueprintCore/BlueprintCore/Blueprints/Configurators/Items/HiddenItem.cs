...
namespace BlueprintCore.Blueprints.Configurators.Items
{
  ...
  {
    private HiddenItemConfigurator(Blueprint<BlueprintHiddenItem, BlueprintReference<BlueprintHiddenItem>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static HiddenItemConfigurator For(Blueprint<BlueprintHiddenItem, BlueprintReference<BlueprintHiddenItem>> blueprint)
    {

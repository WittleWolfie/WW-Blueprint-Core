...
namespace BlueprintCore.Blueprints.Configurators.Items
{
  ...
  {
    private ItemNoteConfigurator(Blueprint<BlueprintReference<BlueprintItemNote>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ItemNoteConfigurator For(Blueprint<BlueprintReference<BlueprintItemNote>> blueprint)
    {
    ...
    public ItemNoteConfigurator CopyFrom(

...
namespace BlueprintCore.Blueprints.Configurators.Items.Equipment
{
  ...
  {
    private ItemEquipmentHeadConfigurator(Blueprint<BlueprintItemEquipmentHead, BlueprintReference<BlueprintItemEquipmentHead>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ItemEquipmentHeadConfigurator For(Blueprint<BlueprintItemEquipmentHead, BlueprintReference<BlueprintItemEquipmentHead>> blueprint)
    {

...
namespace BlueprintCore.Blueprints.Configurators.Items.Equipment
{
  ...
  {
    private ItemEquipmentBeltConfigurator(Blueprint<BlueprintItemEquipmentBelt, BlueprintReference<BlueprintItemEquipmentBelt>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ItemEquipmentBeltConfigurator For(Blueprint<BlueprintItemEquipmentBelt, BlueprintReference<BlueprintItemEquipmentBelt>> blueprint)
    {

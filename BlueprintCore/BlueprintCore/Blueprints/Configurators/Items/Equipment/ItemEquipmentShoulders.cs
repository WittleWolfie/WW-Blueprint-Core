...
namespace BlueprintCore.Blueprints.Configurators.Items.Equipment
{
  ...
  {
    private ItemEquipmentShouldersConfigurator(Blueprint<BlueprintItemEquipmentShoulders, BlueprintReference<BlueprintItemEquipmentShoulders>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ItemEquipmentShouldersConfigurator For(Blueprint<BlueprintItemEquipmentShoulders, BlueprintReference<BlueprintItemEquipmentShoulders>> blueprint)
    {

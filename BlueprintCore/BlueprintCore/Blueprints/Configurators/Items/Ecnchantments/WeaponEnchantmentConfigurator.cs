...
namespace BlueprintCore.Blueprints.Configurators.Items.Ecnchantments
{
  ...
  {
    private WeaponEnchantmentConfigurator(Blueprint<BlueprintReference<BlueprintWeaponEnchantment>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static WeaponEnchantmentConfigurator For(Blueprint<BlueprintReference<BlueprintWeaponEnchantment>> blueprint)
    {

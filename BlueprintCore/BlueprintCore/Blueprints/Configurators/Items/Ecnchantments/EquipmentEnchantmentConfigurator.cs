...
namespace BlueprintCore.Blueprints.Configurators.Items.Ecnchantments
{
  ...
  {
    private EquipmentEnchantmentConfigurator(Blueprint<BlueprintReference<BlueprintEquipmentEnchantment>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static EquipmentEnchantmentConfigurator For(Blueprint<BlueprintReference<BlueprintEquipmentEnchantment>> blueprint)
    {
    ...
    public EquipmentEnchantmentConfigurator CopyFrom(

...
namespace BlueprintCore.Blueprints.Configurators
{
  ...
  {
    private ProjectileConfigurator(Blueprint<BlueprintProjectile, BlueprintReference<BlueprintProjectile>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ProjectileConfigurator For(Blueprint<BlueprintProjectile, BlueprintReference<BlueprintProjectile>> blueprint)
    {

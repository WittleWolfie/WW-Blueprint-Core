...
namespace BlueprintCore.Blueprints.Configurators.Dungeon
{
  ...
  {
    private DungeonLocalizedStringsConfigurator(Blueprint<BlueprintDungeonLocalizedStrings, BlueprintReference<BlueprintDungeonLocalizedStrings>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static DungeonLocalizedStringsConfigurator For(Blueprint<BlueprintDungeonLocalizedStrings, BlueprintReference<BlueprintDungeonLocalizedStrings>> blueprint)
    {

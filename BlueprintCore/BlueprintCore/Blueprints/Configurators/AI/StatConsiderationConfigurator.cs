...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private StatConsiderationConfigurator(Blueprint<BlueprintReference<StatConsideration>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static StatConsiderationConfigurator For(Blueprint<BlueprintReference<StatConsideration>> blueprint)
    {
    ...
    public StatConsiderationConfigurator CopyFrom(

...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private DistanceConsiderationConfigurator(Blueprint<BlueprintReference<DistanceConsideration>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static DistanceConsiderationConfigurator For(Blueprint<BlueprintReference<DistanceConsideration>> blueprint)
    {
    ...
    public DistanceConsiderationConfigurator CopyFrom(

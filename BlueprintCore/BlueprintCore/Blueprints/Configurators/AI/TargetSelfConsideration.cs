...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private TargetSelfConsiderationConfigurator(Blueprint<TargetSelfConsideration, BlueprintReference<TargetSelfConsideration>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static TargetSelfConsiderationConfigurator For(Blueprint<TargetSelfConsideration, BlueprintReference<TargetSelfConsideration>> blueprint)
    {

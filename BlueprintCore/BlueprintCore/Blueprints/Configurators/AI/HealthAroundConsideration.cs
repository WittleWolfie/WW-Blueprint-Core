...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private HealthAroundConsiderationConfigurator(Blueprint<HealthAroundConsideration, BlueprintReference<HealthAroundConsideration>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static HealthAroundConsiderationConfigurator For(Blueprint<HealthAroundConsideration, BlueprintReference<HealthAroundConsideration>> blueprint)
    {

...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private CanMakeFullAttackConsiderationConfigurator(Blueprint<CanMakeFullAttackConsideration, BlueprintReference<CanMakeFullAttackConsideration>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static CanMakeFullAttackConsiderationConfigurator For(Blueprint<CanMakeFullAttackConsideration, BlueprintReference<CanMakeFullAttackConsideration>> blueprint)
    {

...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private AiAttackConfigurator(Blueprint<BlueprintAiAttack, BlueprintReference<BlueprintAiAttack>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static AiAttackConfigurator For(Blueprint<BlueprintAiAttack, BlueprintReference<BlueprintAiAttack>> blueprint)
    {

...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private CommandCooldownConsiderationConfigurator(Blueprint<CommandCooldownConsideration, BlueprintReference<CommandCooldownConsideration>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static CommandCooldownConsiderationConfigurator For(Blueprint<CommandCooldownConsideration, BlueprintReference<CommandCooldownConsideration>> blueprint)
    {

...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private ManualTargetConsiderationConfigurator(Blueprint<BlueprintReference<ManualTargetConsideration>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ManualTargetConsiderationConfigurator For(Blueprint<BlueprintReference<ManualTargetConsideration>> blueprint)
    {
    ...
    public ManualTargetConsiderationConfigurator CopyFrom(

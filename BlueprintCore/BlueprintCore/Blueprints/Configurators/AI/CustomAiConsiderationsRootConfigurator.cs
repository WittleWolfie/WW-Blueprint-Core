...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private CustomAiConsiderationsRootConfigurator(Blueprint<BlueprintReference<CustomAiConsiderationsRoot>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static CustomAiConsiderationsRootConfigurator For(Blueprint<BlueprintReference<CustomAiConsiderationsRoot>> blueprint)
    {
    ...
    public CustomAiConsiderationsRootConfigurator CopyFrom(

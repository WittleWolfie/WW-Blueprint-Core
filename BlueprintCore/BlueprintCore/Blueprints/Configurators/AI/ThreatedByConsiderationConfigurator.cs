...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private ThreatedByConsiderationConfigurator(Blueprint<BlueprintReference<ThreatedByConsideration>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ThreatedByConsiderationConfigurator For(Blueprint<BlueprintReference<ThreatedByConsideration>> blueprint)
    {
    ...
    public ThreatedByConsiderationConfigurator CopyFrom(
    ...
    public ThreatedByConsiderationConfigurator CopyFrom(
      Blueprint<BlueprintReference<ThreatedByConsideration>> blueprint, Predicate<BlueprintComponent> componentMatcher)
    {

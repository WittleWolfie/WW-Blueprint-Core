...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private HasAutoCastConsideraionConfigurator(Blueprint<BlueprintReference<HasAutoCastConsideraion>> blueprint) : base(blueprint) { }
    ...
    public HasAutoCastConsideraionConfigurator CopyFrom(

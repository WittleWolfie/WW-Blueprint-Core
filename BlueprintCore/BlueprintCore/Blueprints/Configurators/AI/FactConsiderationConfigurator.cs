...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private FactConsiderationConfigurator(Blueprint<BlueprintReference<FactConsideration>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static FactConsiderationConfigurator For(Blueprint<BlueprintReference<FactConsideration>> blueprint)
    {
    ...
    public FactConsiderationConfigurator CopyFrom(

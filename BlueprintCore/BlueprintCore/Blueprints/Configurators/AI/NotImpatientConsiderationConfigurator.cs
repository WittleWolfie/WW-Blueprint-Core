...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private NotImpatientConsiderationConfigurator(Blueprint<BlueprintReference<NotImpatientConsideration>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static NotImpatientConsiderationConfigurator For(Blueprint<BlueprintReference<NotImpatientConsideration>> blueprint)
    {
    ...
    public NotImpatientConsiderationConfigurator CopyFrom(

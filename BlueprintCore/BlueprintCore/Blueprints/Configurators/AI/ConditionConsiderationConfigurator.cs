...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private ConditionConsiderationConfigurator(Blueprint<BlueprintReference<ConditionConsideration>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ConditionConsiderationConfigurator For(Blueprint<BlueprintReference<ConditionConsideration>> blueprint)
    {
    ...
    public ConditionConsiderationConfigurator CopyFrom(

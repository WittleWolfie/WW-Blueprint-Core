...
namespace BlueprintCore.Blueprints.Configurators.AI
{
  ...
  {
    private TargetMainCharacterConfigurator(Blueprint<TargetMainCharacter, BlueprintReference<TargetMainCharacter>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static TargetMainCharacterConfigurator For(Blueprint<TargetMainCharacter, BlueprintReference<TargetMainCharacter>> blueprint)
    {

...
namespace BlueprintCore.Blueprints.Configurators.Root
{
  ...
  public class RootConfigurator
    : BaseRootConfigurator<BlueprintRoot, RootConfigurator>
  {
    private RootConfigurator(Blueprint<BlueprintRoot, BlueprintReference<BlueprintRoot>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static RootConfigurator For(Blueprint<BlueprintRoot, BlueprintReference<BlueprintRoot>> blueprint)
    {
      return new RootConfigurator(blueprint);
    }
    /// <summary>

...
namespace BlueprintCore.Blueprints.Configurators.Root
{
  ...
  {
    private RootConfigurator(Blueprint<BlueprintReference<BlueprintRoot>> blueprint) : base(blueprint) { }
    ...
    public RootConfigurator CopyFrom(
      Blueprint<BlueprintReference<BlueprintRoot>> blueprint, params Type[] componentTypes)
    {

...
namespace BlueprintCore.Blueprints.Configurators.Root
{
  ...
  {
    private FormationsRootConfigurator(Blueprint<FormationsRoot, BlueprintReference<FormationsRoot>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static FormationsRootConfigurator For(Blueprint<FormationsRoot, BlueprintReference<FormationsRoot>> blueprint)
    {

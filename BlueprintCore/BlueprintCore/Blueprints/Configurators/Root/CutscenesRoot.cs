...
namespace BlueprintCore.Blueprints.Configurators.Root
{
  ...
  {
    private CutscenesRootConfigurator(Blueprint<CutscenesRoot, BlueprintReference<CutscenesRoot>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static CutscenesRootConfigurator For(Blueprint<CutscenesRoot, BlueprintReference<CutscenesRoot>> blueprint)
    {

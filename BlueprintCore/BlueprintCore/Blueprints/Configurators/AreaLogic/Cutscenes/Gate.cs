...
namespace BlueprintCore.Blueprints.Configurators.AreaLogic.Cutscenes
{
  ...
  {
    private GateConfigurator(Blueprint<Gate, BlueprintReference<Gate>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static GateConfigurator For(Blueprint<Gate, BlueprintReference<Gate>> blueprint)
    {

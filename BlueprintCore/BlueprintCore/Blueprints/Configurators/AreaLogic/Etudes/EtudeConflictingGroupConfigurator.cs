...
namespace BlueprintCore.Blueprints.Configurators.AreaLogic.Etudes
{
  ...
  {
    private EtudeConflictingGroupConfigurator(Blueprint<BlueprintReference<BlueprintEtudeConflictingGroup>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static EtudeConflictingGroupConfigurator For(Blueprint<BlueprintReference<BlueprintEtudeConflictingGroup>> blueprint)
    {
    ...
    public EtudeConflictingGroupConfigurator CopyFrom(
      Blueprint<BlueprintReference<BlueprintEtudeConflictingGroup>> blueprint, Predicate<BlueprintComponent> componentMatcher)
    {

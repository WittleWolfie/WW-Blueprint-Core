...
namespace BlueprintCore.Blueprints.Configurators
{
  ...
  {
    private ControllableProjectileConfigurator(Blueprint<BlueprintReference<BlueprintControllableProjectile>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ControllableProjectileConfigurator For(Blueprint<BlueprintReference<BlueprintControllableProjectile>> blueprint)
    {
    ...
    public ControllableProjectileConfigurator CopyFrom(

...
namespace BlueprintCore.Blueprints.Configurators.Craft
{
  ...
  {
    private IngredientConfigurator(Blueprint<BlueprintIngredient, BlueprintReference<BlueprintIngredient>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static IngredientConfigurator For(Blueprint<BlueprintIngredient, BlueprintReference<BlueprintIngredient>> blueprint)
    {

...
namespace BlueprintCore.Blueprints.Configurators
{
  ...
  {
    private ProjectileTrajectoryConfigurator(Blueprint<BlueprintReference<BlueprintProjectileTrajectory>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ProjectileTrajectoryConfigurator For(Blueprint<BlueprintReference<BlueprintProjectileTrajectory>> blueprint)
    {
    ...
    public ProjectileTrajectoryConfigurator CopyFrom(

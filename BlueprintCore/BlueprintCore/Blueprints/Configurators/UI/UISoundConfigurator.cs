...
using BlueprintCore.Blueprints.Configurators.UI;
...
namespace BlueprintCore.Blueprints.Configurators.UI
{
  ...
  {
    private UISoundConfigurator(Blueprint<BlueprintReference<BlueprintUISound>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static UISoundConfigurator For(Blueprint<BlueprintReference<BlueprintUISound>> blueprint)
    {

...
namespace BlueprintCore.Blueprints.Configurators.Visual
{
  ...
  {
    private HitSystemRootConfigurator(Blueprint<HitSystemRoot, BlueprintReference<HitSystemRoot>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static HitSystemRootConfigurator For(Blueprint<HitSystemRoot, BlueprintReference<HitSystemRoot>> blueprint)
    {

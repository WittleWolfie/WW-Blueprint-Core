...
using BlueprintCore.Blueprints.Configurators.Footrprints;
...
namespace BlueprintCore.Blueprints.Configurators.Footrprints
{
  ...
  {
    private FootprintConfigurator(Blueprint<BlueprintReference<BlueprintFootprint>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static FootprintConfigurator For(Blueprint<BlueprintReference<BlueprintFootprint>> blueprint)
    {

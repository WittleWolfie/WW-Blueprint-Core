...
namespace BlueprintCore.Blueprints.Configurators.Footrprints
{
  ...
  {
    private FootprintTypeConfigurator(Blueprint<BlueprintFootprintType, BlueprintReference<BlueprintFootprintType>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static FootprintTypeConfigurator For(Blueprint<BlueprintFootprintType, BlueprintReference<BlueprintFootprintType>> blueprint)
    {

...
namespace BlueprintCore.Blueprints.Configurators
{
  ...
  {
    private UnitTemplateConfigurator(Blueprint<BlueprintReference<BlueprintUnitTemplate>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static UnitTemplateConfigurator For(Blueprint<BlueprintReference<BlueprintUnitTemplate>> blueprint)
    {
    ...
    public UnitTemplateConfigurator CopyFrom(

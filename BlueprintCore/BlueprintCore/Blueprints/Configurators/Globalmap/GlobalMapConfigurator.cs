...
namespace BlueprintCore.Blueprints.Configurators.Globalmap
{
  ...
  {
    private GlobalMapConfigurator(Blueprint<BlueprintReference<BlueprintGlobalMap>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static GlobalMapConfigurator For(Blueprint<BlueprintReference<BlueprintGlobalMap>> blueprint)
    {
    ...
    public GlobalMapConfigurator CopyFrom(

...
namespace BlueprintCore.Blueprints.Configurators.Globalmap
{
  ...
  {
    private GlobalMapPointVariationConfigurator(Blueprint<BlueprintGlobalMapPointVariation, BlueprintReference<BlueprintGlobalMapPointVariation>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static GlobalMapPointVariationConfigurator For(Blueprint<BlueprintGlobalMapPointVariation, BlueprintReference<BlueprintGlobalMapPointVariation>> blueprint)
    {

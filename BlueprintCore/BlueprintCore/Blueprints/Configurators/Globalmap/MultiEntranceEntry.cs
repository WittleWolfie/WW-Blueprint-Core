...
namespace BlueprintCore.Blueprints.Configurators.Globalmap
{
  ...
  {
    private MultiEntranceEntryConfigurator(Blueprint<BlueprintReference<BlueprintMultiEntranceEntry>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static MultiEntranceEntryConfigurator For(Blueprint<BlueprintReference<BlueprintMultiEntranceEntry>> blueprint)
    {

...
namespace BlueprintCore.Blueprints.Configurators.Classes
{
  ...
  {
    private RaceConfigurator(Blueprint<BlueprintRace, BlueprintReference<BlueprintRace>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static RaceConfigurator For(Blueprint<BlueprintRace, BlueprintReference<BlueprintRace>> blueprint)
    {

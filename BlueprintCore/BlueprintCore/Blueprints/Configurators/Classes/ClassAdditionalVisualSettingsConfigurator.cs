...
namespace BlueprintCore.Blueprints.Configurators.Classes
{
  ...
  {
    private ClassAdditionalVisualSettingsConfigurator(Blueprint<BlueprintReference<BlueprintClassAdditionalVisualSettings>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ClassAdditionalVisualSettingsConfigurator For(Blueprint<BlueprintReference<BlueprintClassAdditionalVisualSettings>> blueprint)
    {
    ...
    public ClassAdditionalVisualSettingsConfigurator CopyFrom(

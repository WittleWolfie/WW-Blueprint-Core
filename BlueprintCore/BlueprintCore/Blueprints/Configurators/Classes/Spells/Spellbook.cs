...
namespace BlueprintCore.Blueprints.Configurators.Classes.Spells
{
  ...
  {
    private SpellbookConfigurator(Blueprint<BlueprintSpellbook, BlueprintReference<BlueprintSpellbook>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static SpellbookConfigurator For(Blueprint<BlueprintSpellbook, BlueprintReference<BlueprintSpellbook>> blueprint)
    {

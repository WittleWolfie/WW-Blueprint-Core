...
namespace BlueprintCore.Blueprints.Configurators.Classes.Spells
{
  ...
  {
    private SpellsTableConfigurator(Blueprint<BlueprintReference<BlueprintSpellsTable>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static SpellsTableConfigurator For(Blueprint<BlueprintReference<BlueprintSpellsTable>> blueprint)
    {
    ...
    public SpellsTableConfigurator CopyFrom(

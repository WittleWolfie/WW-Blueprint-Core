...
namespace BlueprintCore.Blueprints.Configurators.Classes
{
  ...
  {
    private ArchetypeConfigurator(Blueprint<BlueprintArchetype, BlueprintReference<BlueprintArchetype>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static ArchetypeConfigurator For(Blueprint<BlueprintArchetype, BlueprintReference<BlueprintArchetype>> blueprint)
    {

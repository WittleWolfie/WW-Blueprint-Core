...
namespace BlueprintCore.Blueprints.Configurators.Classes
{
  ...
  {
    private FeatureReplaceSpellbookConfigurator(Blueprint<BlueprintReference<BlueprintFeatureReplaceSpellbook>> blueprint) : base(blueprint) { }
    ...
    public FeatureReplaceSpellbookConfigurator CopyFrom(

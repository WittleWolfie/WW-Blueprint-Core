...
namespace BlueprintCore.Blueprints.Configurators.Classes
{
  ...
  {
    protected BaseCharacterClassGroupConfigurator(Blueprint<T, BlueprintReference<T>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </param>
    public TBuilder AddToCharacterClasses(params Blueprint<BlueprintCharacterClass, BlueprintCharacterClassReference>[] characterClasses)
    {
      return OnConfigureInternal(
        bp =>
        {
    ...
    /// </para>
    /// </param>
    public TBuilder RemoveFromCharacterClasses(params Blueprint<BlueprintCharacterClass, BlueprintCharacterClassReference>[] characterClasses)
    {
      return OnConfigureInternal(
        bp =>
        {

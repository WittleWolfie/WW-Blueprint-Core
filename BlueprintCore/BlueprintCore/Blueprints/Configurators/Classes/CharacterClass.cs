...
namespace BlueprintCore.Blueprints.Configurators.Classes
{
  ...
  {
    private CharacterClassConfigurator(Blueprint<BlueprintCharacterClass, BlueprintReference<BlueprintCharacterClass>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static CharacterClassConfigurator For(Blueprint<BlueprintCharacterClass, BlueprintReference<BlueprintCharacterClass>> blueprint)
    {

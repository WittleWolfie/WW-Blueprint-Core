...
namespace BlueprintCore.Blueprints.Configurators.Classes
{
  ...
  {
    private FeatureConfigurator(Blueprint<BlueprintFeature, BlueprintReference<BlueprintFeature>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static FeatureConfigurator For(Blueprint<BlueprintFeature, BlueprintReference<BlueprintFeature>> blueprint)
    {

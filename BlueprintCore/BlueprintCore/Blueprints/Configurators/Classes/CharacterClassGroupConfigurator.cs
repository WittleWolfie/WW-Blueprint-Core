...
namespace BlueprintCore.Blueprints.Configurators.Classes
{
  ...
  {
    private CharacterClassGroupConfigurator(Blueprint<BlueprintReference<BlueprintCharacterClassGroup>> blueprint) : base(blueprint) { }
    ...
    /// </para>
    /// </remarks>
    public static CharacterClassGroupConfigurator For(Blueprint<BlueprintReference<BlueprintCharacterClassGroup>> blueprint)
    {
    ...
    public CharacterClassGroupConfigurator CopyFrom(
    ...
    public CharacterClassGroupConfigurator CopyFrom(
      Blueprint<BlueprintReference<BlueprintCharacterClassGroup>> blueprint, Predicate<BlueprintComponent> componentMatcher)
    {

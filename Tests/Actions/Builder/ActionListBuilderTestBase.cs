...
namespace BlueprintCore.Tests.Actions.Builder
{
  ...
  public abstract class ActionListBuilderTestBase : IDisposable
  {
    ...
    protected readonly AchievementData Achievement =
        BlueprintPatch.Create<AchievementData>(AchievementGuid);
    ...
    protected readonly BlueprintAbility Ability =
        BlueprintPatch.Create<BlueprintAbility>(AbilityGuid);
    ...
    protected readonly BlueprintAbilityAreaEffect AbilityAOE =
        BlueprintPatch.Create<BlueprintAbilityAreaEffect>(AbilityAOEGuid);
    ...
    protected readonly BlueprintAbilityResource AbilityResource =
        BlueprintPatch.Create<BlueprintAbilityResource>(AbilityResourceGuid);
    ...
    protected readonly BlueprintActionList ActionList =
        BlueprintPatch.Create<BlueprintActionList>(ActionListGuid);
    ...
    protected readonly BlueprintAreaEnterPoint AreaEnterPoint =
        BlueprintPatch.Create<BlueprintAreaEnterPoint>(AreaEnterPointGuid);

    //----- BlueprintArmyPreset -----//
    protected static readonly string ArmyGuid = "b8309f5f-7ac5-468b-a9e7-98cb805da802";
    protected readonly BlueprintArmyPreset Army = BlueprintPatch.Create<BlueprintArmyPreset>(ArmyGuid);
    ...
    protected readonly BlueprintArmyLeader ArmyLeader =
        BlueprintPatch.Create<BlueprintArmyLeader>(ArmyLeaderGuid);
    ...
    protected readonly BlueprintCampingEncounter CampingEncounter =
        BlueprintPatch.Create<BlueprintCampingEncounter>(CampingEncounterGuid);
    ...
    protected readonly BlueprintControllableProjectile ControllableProjectile =
        BlueprintPatch.Create<BlueprintControllableProjectile>(ControllableProjectileGuid);
    ...
    protected readonly BlueprintEquipmentEnchantment EquipmentEnchantment =
        BlueprintPatch.Create<BlueprintEquipmentEnchantment>(EquipmentEnchantmentGuid);
    ...
    protected readonly BlueprintFaction Faction = BlueprintPatch.Create<BlueprintFaction>(FactionGuid);
    ...
    protected readonly BlueprintFeatureSelection FeatureSelection =
            BlueprintPatch.Create<BlueprintFeatureSelection>(FeatureSelectionGuid);
    ...
    protected readonly BlueprintGlobalMapPoint GlobalMapPoint =
        BlueprintPatch.Create<BlueprintGlobalMapPoint>(GlobalMapPointGuid);
    ...
    protected readonly BlueprintGlobalMagicSpell GlobalSpell =
        BlueprintPatch.Create<BlueprintGlobalMagicSpell>(GlobalSpellGuid);

    //----- BlueprintItem -----//
    protected static readonly string ItemGuid = "e538ae39-cdd1-494b-b03b-b934b9da8dee";
    protected readonly BlueprintItem Item = BlueprintPatch.Create<BlueprintItem>(ItemGuid);

    //----- BlueprintItemArmor -----//
    protected static readonly string ArmorGuid = "e4cafa6f-5ca0-4b7a-9eec-1172eaf63bbf";
    protected readonly BlueprintItemArmor Armor = BlueprintPatch.Create<BlueprintItemArmor>(ArmorGuid);
    ...
    protected readonly BlueprintItemEquipmentHandSimple SimpleHandItem =
        BlueprintPatch.Create<BlueprintItemEquipmentHandSimple>(SimpleHandItemGuid);

    //----- BlueprintItemWeapon -----//
    protected static readonly string WeaponGuid = "9cf61faf-4ae9-47a0-b325-2fabb13bc9e2";
    protected readonly BlueprintItemWeapon Weapon = BlueprintPatch.Create<BlueprintItemWeapon>(WeaponGuid);
    ...
    protected readonly BlueprintKingdomArtisan Artisan =
        BlueprintPatch.Create<BlueprintKingdomArtisan>(ArtisanGuid);
    ...
    protected readonly BlueprintKingdomBuff KingdomBuff =
        BlueprintPatch.Create<BlueprintKingdomBuff>(KingdomBuffGuid);

    // //----- BlueprintKingdomDeck -----//
    protected static readonly string DeckGuid = "948ab7c7-5b44-415b-8fb2-8ac136d10401";
    protected readonly BlueprintKingdomDeck Deck = BlueprintPatch.Create<BlueprintKingdomDeck>(DeckGuid);
    ...
    protected readonly BlueprintKingdomProject Project =
        BlueprintPatch.Create<BlueprintKingdomProject>(ProjectGuid);
    ...
    protected readonly BlueprintProjectile Projectile =
        BlueprintPatch.Create<BlueprintProjectile>(ProjectileGuid);
    ...
    protected readonly BlueprintQuestObjective QuestObjective =
        BlueprintPatch.Create<BlueprintQuestObjective>(QuestObjectiveGuid);

    //----- BlueprintRegion -----//
    protected static readonly string RegionGuid = "373f4c50-c351-4f1d-b95f-8129a352b943";
    protected readonly BlueprintRegion Region = BlueprintPatch.Create<BlueprintRegion>(RegionGuid);
    ...
    protected readonly BlueprintRomanceCounter Romance =
        BlueprintPatch.Create<BlueprintRomanceCounter>(RomanceGuid);
    ...
    protected readonly BlueprintSettlement Settlement =
            BlueprintPatch.Create<BlueprintSettlement>(SettlementGuid);
    ...
    protected readonly BlueprintSettlementBuilding SettlementBuilding =
        BlueprintPatch.Create<BlueprintSettlementBuilding>(SettlementBuildingGuid);
    ...
    protected readonly SettlementBuildList BuildList =
            BlueprintPatch.Create<SettlementBuildList>(BuildListGuid);
    ...
    protected readonly BlueprintSharedVendorTable VendorTable =
        BlueprintPatch.Create<BlueprintSharedVendorTable>(VendorTableGuid);
    ...
    protected readonly BlueprintSpellbook Spellbook =
        BlueprintPatch.Create<BlueprintSpellbook>(SpellbookGuid);
    ...
    protected readonly BlueprintSpellbook ExtraSpellbook =
        BlueprintPatch.Create<BlueprintSpellbook>(ExtraSpellbookGuid);
    ...
    protected readonly BlueprintSummonPool SummonPool =
        BlueprintPatch.Create<BlueprintSummonPool>(SummonPoolGuid);

    //----- BlueprintUnit -----//
    protected static readonly string UnitGuid = "83dd1ece-33da-4702-a3b1-5b623b0864c4";
    protected readonly BlueprintUnit Unit = BlueprintPatch.Create<BlueprintUnit>(UnitGuid);

    //----- BlueprintUnitLoot -----//
    protected static readonly string LootGuid = "da81b8a8-ebd7-4c20-8b44-8ee1183b4df3";
    protected readonly BlueprintUnitLoot Loot = BlueprintPatch.Create<BlueprintUnitLoot>(LootGuid);

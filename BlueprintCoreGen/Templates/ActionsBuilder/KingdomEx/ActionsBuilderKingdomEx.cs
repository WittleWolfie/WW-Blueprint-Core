...
namespace BlueprintCoreGen.Actions.Builder.KingdomEx
{
  ...
  public static class ActionsBuilderKingdomEx
  {
    ...
    // [Generate(Kingmaker.Kingdom.Flags.KingdomFlagIncrement)]
    // [Generate(Kingmaker.Kingdom.Flags.KingdomMoraleFlagUpdateIncome)]
    // [Generate(Kingmaker.Kingdom.Flags.KingdomMoraleUpdateIncome)]
    // [Generate(Kingmaker.Kingdom.Flags.KingdomRemoveMoraleFlags)]
    // [Generate(Kingmaker.Kingdom.Flags.KingdomSetFlagState)]
    // [Generate(Kingmaker.Kingdom.Flags.ReduceNegativeMorale)]
    // [Generate(Kingmaker.Kingdom.Armies.Actions.AddGrowthBonus)]
    // [Generate(Kingmaker.Kingdom.Armies.Actions.AddMercenaryToPool)]
    // [Generate(Kingmaker.Kingdom.Armies.Actions.AddTacticalArmyFeature)]
    // [Generate(Kingmaker.Kingdom.Armies.Actions.ChangeMercenaryWeight)]
    // [Generate(Kingmaker.Kingdom.Armies.Actions.DecreaseRecruitsGrowth)]
    // [Generate(Kingmaker.Kingdom.Armies.Actions.DecreaseRecruitsPool)]
    // [Generate(Kingmaker.Kingdom.Armies.Actions.ExchangeRecruits)]
    // [Generate(Kingmaker.Kingdom.Armies.Actions.IncreaseRecruitsGrowth)]
    // [Generate(Kingmaker.Kingdom.Armies.Actions.IncreaseRecruitsPool)]
    // [Generate(Kingmaker.Kingdom.Armies.Actions.RemoveMercenaryFromPool)]
    // [Generate(Kingmaker.Kingdom.Armies.Actions.ReplaceBuildings)]
    // [Generate(Kingmaker.Kingdom.Armies.Actions.SetRecruitPoint)]
    // [Generate(Kingmaker.Kingdom.Armies.Actions.UnlockUnitsGrowth)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionGetArtisanGift)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionGetArtisanGiftWithCertainTier)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionGetPartyGoldByUnitsCount)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionGetResourcesByUnitsCount)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionGetResourcesPercent)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionGiveLoot)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionImproveSettlement)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionImproveStat)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionMakeRoll)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionModifyBuildTime)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionModifyClaims)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionModifyEventDC)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionModifyRE)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionModifyRankTime)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionModifyStatRandom)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionModifyStats)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionModifyUnrest)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionNextChapter)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionPullRankupChangesIntoDialog)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionRemoveAllLeaders)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionRemoveBuff)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionRemoveEvent)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionRemoveEventDeck)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionRequestArtisanGift)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionResetRecurrence)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionResolveCrusadeEvent)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionResolveEvent)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionResolveProject)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionRestartEvent)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionRollbackRecurrence)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionSetAlignment)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionSetNotVisible)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionSetRegionalIncome)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionSetVisible)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionSpawnRandomArmy)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionStartEvent)]
    // [Generate(Kingmaker.Kingdom.Actions.KingdomActionUnlockArtisan)]
    ...
    // [Generate(Kingmaker.Armies.TacticalCombat.GameActions.ContextActionByArmyLeader)]

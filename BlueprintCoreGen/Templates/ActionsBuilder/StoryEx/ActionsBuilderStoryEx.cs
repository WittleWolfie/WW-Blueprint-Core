...
namespace BlueprintCoreGen.Actions.Builder.StoryEx
{
  ...
  public static class ActionsBuilderStoryEx
  {
    ...
    // [Generate(Kingmaker.Designers.EventConditionActionSystem.Actions.SplitUnitGroup)]
    // [Generate(Kingmaker.Designers.EventConditionActionSystem.Actions.StartCombat)]
    // [Generate(Kingmaker.Designers.EventConditionActionSystem.Actions.StartDialog)]
    // [Generate(Kingmaker.Designers.EventConditionActionSystem.Actions.StartEncounter)]
    ...
    // [Generate(Kingmaker.Designers.EventConditionActionSystem.Actions.SwitchToEnemy)]
    // [Generate(Kingmaker.Designers.EventConditionActionSystem.Actions.SwitchToNeutral)]
    // [Generate(Kingmaker.Designers.EventConditionActionSystem.Actions.TimeSkip)]
    // [Generate(Kingmaker.Designers.EventConditionActionSystem.Actions.UnitLookAt)]
